...
export const stateSchemaPassword = {
    newPassword: {value: '', error: '', errorfield: false},
    confirmNewPassword: {value: '', error: '', errorfield: false}
}
...
const useFormValidationResetPassword = (stateSchema, validationSchema = {}, disableSchema) => {
    ...
    useEffect(() => {
        ...
        } else if (state.newPassword.error) {
            setDisable(() => ({
                ...disableSchema,
                status: true,
...
export default useFormValidationResetPassword;